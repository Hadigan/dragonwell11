...
void StubRoutines::initialize1() {
  if (_code1 == NULL) {
    ...
    if (MoveStubroutinesToNonProfileCodeHeap)
      _code1 = BufferBlob::create("StubRoutines (1)", code_size1, CodeBlobType::MethodNonProfiled);
    else
...
void StubRoutines::initialize2() {
  if (_code2 == NULL) {
    ...
    if (MoveStubroutinesToNonProfileCodeHeap)
      _code2 = BufferBlob::create("StubRoutines (2)", code_size2, CodeBlobType::MethodNonProfiled);
    else

...
class VtableStubs : AllStatic {
 ...
 private:
  ...
  static VtableStub* _new_table[N];              // table of reordering new stubs

  static VtableStub* create_vtable_stub(int vtable_index, int code_blob_type=CodeBlobType::NonNMethod);
  static VtableStub* create_itable_stub(int vtable_index, int code_blob_type=CodeBlobType::NonNMethod);
  ...
  static void        check_and_set_size_limit(bool is_vtable_stub,
                                              int   code_size,
                                              int   padding);
  static void        enter_new_table(bool is_vtable_stub, int vtable_index, VtableStub* s);
 ...
 public:
  ...
  static void        create_reorder_stub(bool is_vtable_stub, int vtable_index);
};
...
class VtableStub {
 private:
  ...
  static VtableBlob* _last_vb;
  static VMReg   _receiver_location; // Where to find receiver
  VtableBlob*    _vb;                // for blob size printing
  ...
  void* operator new(size_t size, int code_size, int code_blob_type=CodeBlobType::NonNMethod) throw();

  VtableStub(bool is_vtable_stub, int index)
        : _next(NULL), _is_vtable_stub(is_vtable_stub),
          _index(index), _ame_offset(-1), _npe_offset(-1), _vb(_last_vb) {}
 ...
 public:
  ...
  VtableBlob* vtable_blob()                      { return _vb; }
 ...
 public:
  ...
  const short index()                            { return _index; }
